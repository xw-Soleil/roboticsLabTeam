...
def test():
    ...
    q2 = iks.solve(np.array([0.051780861973690, -0.389209243590751, 0.12, -178.49/180 * np.pi, 0, 10.78/180*np.pi]))[:, 2]
    q3 = iks.solve(np.array([0.356112642250006, 0.097050798735177, 0.093340875363385, -np.pi, 0, -np.pi/2]))[:, 2]
